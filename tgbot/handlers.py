...
async def greet_new_members(message: Message):
    ...
    for new_member in message.new_chat_members:
        ...
        Мы качаем учеников, делимся полезной информацией, отвечаем на вопросы, участвуем в клановых мероприятиях, организуем сборы, помогаем с прокачкой, ищем и приводим новых людей, проводим собеседования, разбираемся с варами (если изредка они появляются) и др.
        Если ты новичок, то нам нужно увидеть, как ты сможешь поучаствовать в развитии клана, как ты сможешь нас усилить. Прокачка своих основных персонажей и выполнение клановых миссий не считается. Это то, что каждый должен делать по умолчанию.
