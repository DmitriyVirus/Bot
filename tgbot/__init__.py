...
# ===== Новые роутеры из папки handlers =====
from tgbot.handlers.menu import router as menu_router         # /bot и меню
from tgbot.handlers.greetings import router as greetings_router  # приветствие / прощание / goodmorning
from tgbot.handlers.triggers import router as triggers_router    # текстовые триггеры
