...
ALLOWED_USER_IDS = {1141764502, 1207400705, 913999355, 559273200, 809946596, 400813982, 706756744, 391990168, 462683759, 6392141586, 337645798, 1705787763, 1116046078}  # Здесь указываем допустимые user_id
