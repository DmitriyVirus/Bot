...
DAREDEVILS = (
    "Мы дружный и веселый клан, который играет исключительно в Lineage II на сервере Айрин.\n"
...
ABOUT_GAME = (
    "Здесь записанны основные данные которые есть у нас об игре, также если интересно что-либо более конкретное, то можно спросить товарищей Евгения(@disika) и Павла(@Pavel1234455).\n\n"
