...
NAME_TABLE = {
    ...
    "Павел":{"name": "Павел(Обезгномливание)", "tgnick": "Павел", "nick": "@Pavel1234455", "about": "Средний сум. Помощник по инстам. Подскажет по сумам. Активный."},
    "Крис":{"name": "Кристина(СерыеГлазки)", "tgnick": "Крис", "nick": "@krisdnk", "about": "Хил. Тонкий. Активная."},
