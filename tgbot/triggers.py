...
NAME_TABLE = {
    ...
    "Леонид":{"name": "Леонид(ТуманныйТор)", "nick": "нет", "about": "Высокоуровневый сум. Активный."},
    "Дмитрий":{"name": "Дмитрий(маКароноВирус)", "nick": "@DDestopia", "about": "Хил. Тонкий. Болтливй."},
    "Игорь":{"name": "Игорь(ФунтАпельсинов)", "nick": "@Just_Reck", "about": "Слабый сум. Тонковатый, но активный."},
    "Shaadun":{"name": "Вячеслав(DumSpiroSpero)", "nick": "нет", "about": "Слабая агуша. Активный."},
    "Jki":{"name": "Александр(Клаар)", "nick": "нет", "about": "Сильный высокоуровневый дк. Активный."},
    "Лёха":{"name": "Алексей(Анфетаминчик)", "nick": "нет", "about": "Высокоуровневый нож. Активен, но молчаливый."},
    ...
    "Иван":{"name": "Иван(xNicEBabYx)", "nick": "нет", "about": "Высокуровневый дк. Молчаливый"},
    ...
    "Oleh":{"name": "Олег(ECL)", "nick": "нет", "about": "Средний дк. Молчун."},
    "GP":{"name": "Георгий(ZeRama)", "nick": "нет", "about": "Нож. Он есть."},
    "Witcher792":{"name": "Владимир(Призывуля215)", "nick": "нет", "about": "Самонер. Он есть."},
    "Rocky":{"name": "Дамир(EvelyneNV)", "nick": "нет", "about": "Средний самонер. Средней активности."},
    "Бишоп":{"name": "Павел(DDextrim)", "nick": "нет", "about": "ПП. Он есть."},
    "Hylio":{"name": "Роман(ХоаН)", "nick": "нет", "about": "Дк. Он есть."},
    "сергей":{"name": "Сергей(iNeer)", "nick": "@GinoLanetty", "about": "Нож. Он есть."},
    "Алена":{"name": "Алена(АЗиЗа)", "nick": "@alenka_azi", "about": "Бд. Она есть."},
    "Artem":{"name": "Артем(DeathDior)", "nick": "@svao92", "about": "Дк. Он есть."},
    "Андрей🍅":{"name": "Андрей(Greshnyy)", "nick": "@Andrey_kisel72", "about": "Дк. Он есть."},
    "Sergey":{"name": "Сергей(Butchery)", "nick": "@ru_vehement", "about": "Вл. Он есть."},
    "Михаил":{"name": "Михаил(Remorse)", "nick": "@RemorseADV", "about": "В активном поиске профессии. У него есть лук. Он есть."}
}
